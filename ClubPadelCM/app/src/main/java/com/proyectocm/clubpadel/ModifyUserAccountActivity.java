...
public class ModifyUserAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendDataButton(userId, dataName, dataSurname, dataPhone);
    ...
    private void sendDataButton(String userId, TextView dataName, TextView dataSurname, TextView dataPhone) {
